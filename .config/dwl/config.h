...
static const Key keys[] = {
  ...
  // { 0,                         XKB_KEY_XF86XK_AudioMute,          spawn,   {.v = volume_tgl} },
  // { 0,                         XKB_KEY_XF86XK_AudioLowerVolume,   spawn,   {.v = volume_sub} },
  // { 0,                         XKB_KEY_XF86XK_AudioRaiseVolume,   spawn,   {.v = volume_add} },
...
//   140 |   { 0,                         XKB_KEY_XF86XK_AudioMute,          spawn,   {.v = volume_tgl} },
//       |                                XKB_KEY_XF86AudioMute
//
//   141 |   { 0,                         XKB_KEY_XF86XK_AudioLowerVolume,   spawn,   {.v = volume_sub} },
//       |                                XKB_KEY_XF86AudioLowerVolume
//
//   142 |   { 0,                         XKB_KEY_XF86XK_AudioRaiseVolume,   spawn,   {.v = volume_add} },
//       |                                XKB_KEY_XF86AudioRaiseVolume
// config.h:142:3: warning: missing initializer for field 'arg' of 'Key' [8;;htt
